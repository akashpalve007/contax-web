<x-layouts.auth>
    ...
    <x-slot name="content">
        <div>
            ...
            <h1 class="text-lg my-3 font-bold">
                {{ trans('auth.login_to') }}
            </h1>
        </div>
        ...
        <x-form id="auth" route="login">
            <div class="grid sm:grid-cols-6 gap-x-8 gap-y-6 my-3.5 lg:h-64">
                ...
                <div class="sm:col-span-6 flex flex-row justify-between items-center">
                    ...
                    <x-link href="{{ route('forgot') }}" class="text-black-400 hover:text-black-700 text-sm" override="class" style="color:#247BFF">
                ...
                <x-button
                    ...
                    override="class" style="background-color:#003fe1;"
                >
                    <x-button.loading>
                        {{ trans('auth.login') }}
                    </x-button.loading>
